          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" className="bg-purple-600 hover:bg-purple-700 text-white w-full py-6">
            ...
            >
              <div>
                ...
                <p className="text-gray-400 mb-8">You can also reach out to us directly using the information below.</p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">info@apptware.com</p>
                  </div>
                </div>
              ...
              <div className="pt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-900 p-3 rounded-full hover:bg-gray-800 transition-colors">
                    <svg className="h-5 w-5 text-purple-500" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path
                        fillRule="evenodd"
